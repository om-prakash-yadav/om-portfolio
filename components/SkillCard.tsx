...
export default function SkillCard({
  ...
  return (
    <div
      className="group w-28 sm:w-32 h-28 sm:h-32 rounded-lg flex flex-col items-center justify-center transition-all duration-300"
    ...
    >
      ...
      <span className="text-xs mt-2 text-foreground text-center px-1">
        {name}
      </span>
    </div>
  );
