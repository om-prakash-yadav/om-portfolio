...
const projects = [
  ...
  },
  {
    ...
    description: "Deloitte USI project: Built scalable modules for Henry Schein's Global E-commerce Platform using Angular, Bootstrap, and Sitecore. Supported 1M+ global customers across 300+ clinical solutions. Received two awards for exceptional delivery. Optimized component rendering and state management, achieving 25% faster load times.",
